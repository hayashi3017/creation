...
use creation_usecase::usecase::{
    ...
    genealogy_world::{GenealogyWorldUsecase, ProvidesGenealogyWorldUsecase},
...
impl GenealogyWorldUsecase for AppModule {}
...
impl ProvidesGenealogyWorldUsecase for AppModule {
    type T = Self;
