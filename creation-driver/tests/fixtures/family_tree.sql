...
INSERT INTO relationship
  (relationship_id, world_id, source_entity_id, target_entity_id, kind, start_date, end_date, notes, deleted_at)
VALUES
  ...
  (6, 1, 8, 9, 'parent', NULL, NULL, 'deleted diagram edge', NULL);
