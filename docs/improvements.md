...
- diagram の論理削除後でも relationship API の read/update/delete がその diagram 配下の行をまだ扱えてしまう。diagram の visibility policy を relationship API にも揃えるなら、soft-deleted diagram をどの時点で 404 扱いにするかを決めた方がよい。
